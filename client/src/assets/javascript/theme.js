...
var Theme = /*#__PURE__*/function ()
{
  ...
  _createClass( Theme, [ {
    ...
    value: function init ()
    {
      ...
      $( 'html' ).removeClass( 'loading' ); // handle polyfill
      // =============================================================
    ...
    key: "toggleAsideCustome",
    value: function toggleAsideCustome ()
    {
      var _this4 = this;
    ...
    {
      // console.log( this.hasCompactMenu );
    ...
    value: function sidebar ()
    {
      ...
      $( document ).off( '[data-toggle="sidebar"], .sidebar-backdrop' ).on( 'click', '[data-toggle="sidebar"], .sidebar-backdrop', function ( e )
      {
        e.preventDefault();
    ...
    {
      return !!window.opr && !!opr.addons || !!window.opera || navigator.userAgent.indexOf( 'OPR/index.html' ) >= 0;
    }
    /**
     * Firefox 1.0+
     * @return {Boolean}
