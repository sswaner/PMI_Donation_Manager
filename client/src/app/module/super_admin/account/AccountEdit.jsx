...
export default function AccountEdit() {
    ...
    let ContactHeader = [
        ...
        },
        {
            ...
            isSortable: true,
            cell: (row) => {
                return <a href={"mailto:" + row.OfficialEmailAddress}>{row.OfficialEmailAddress}</a>
            }
        ...
        },
        {
            ...
            // cell: ( row ) => 
            // {
            //     return <a target="_blank" href={"https://wa.me/"+row.OfficialPhoneNumber}>{row.OfficialPhoneNumber}</a>
            // }
        },
        {
            title: t("page.admin.contactList.ContactChannel"),
            prop: "ContactChannel",
            isSortable: true,
        },
        {
...

        {
            ...
            cell: (row) => {
                return (
                    <>
                        {row.ContactChannel == 'WhatsApp' &&
                            <a 
                            className="btn btn-sm btn-icon btn-success mr-1"
                            target="_blank" 
                            href={"https://wa.me/"+row.OfficialPhoneNumber.replace('+','')}>
